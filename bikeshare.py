...
import numpy as np
import calendar
CITY_DATA = { 'chicago': r'C:\Users\cuongtt17\OneDrive - FPT Corporation\15. Udacity\Programming for Data Science with Python\all-project-files\chicago.csv',
              'new york city': r'C:\Users\cuongtt17\OneDrive - FPT Corporation\15. Udacity\Programming for Data Science with Python\all-project-files\new_york_city.csv',
              'washington': r'C:\Users\cuongtt17\OneDrive - FPT Corporation\15. Udacity\Programming for Data Science with Python\all-project-files\washington.csv' }
